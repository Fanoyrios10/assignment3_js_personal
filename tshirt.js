var Color = require('./t-shirt_variations/color');
var Size = require('./t-shirt_variations/size');
var Fabric = require('./t-shirt_variations/fabric');
...
class TShirt {
    ...
    get fabric() {
        ...
        */
        ...
        return Object.keys(fabric.fabrics).find(
            (k) => fabric.fabrics[k] === this._fabric
        );
    }
